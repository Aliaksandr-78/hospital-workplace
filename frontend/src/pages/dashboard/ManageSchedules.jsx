          ...
          <table className="min-w-full bg-white">
            <thead>
              <tr>
                ...
                {(isAdmin || isNurse) && (<th className="py-2 px-2 sm:px-4 border-b text-xs sm:text-sm">Действия</th>)}
              </tr>
            </thead>
            <tbody>
              {filteredSchedules.length > 0 ? (
                ...
                <tr>
                  <td colSpan={isDoctor ? 5 : 6} className="py-4 text-center text-xs sm:text-sm text-gray-500">
