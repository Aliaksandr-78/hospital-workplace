...
const recordEntryPrescriptionsRoutes = require('./routes/recordEntryPrescriptionsRoutes')
...
app.use('/api/record-entry-prescriptions', recordEntryPrescriptionsRoutes)
